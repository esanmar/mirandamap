...
/**
 * Tool implementation for searching the web using Google Search grounding.
 */
const webSearch: ToolImplementation = async (args, context) => {
  ...
  try {
    ...
    setHeldGroundedResponse(response);
