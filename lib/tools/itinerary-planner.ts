...
export const itineraryPlannerTools: FunctionCall[] = [
  ...
  {
    name: 'webSearch',
    description: 'Searches the web for current events, news, or general information not found on the map. Use this tool when the user asks about "events today", "news", or "weather".',
    parameters: {
      type: 'OBJECT',
      properties: {
        query: {
